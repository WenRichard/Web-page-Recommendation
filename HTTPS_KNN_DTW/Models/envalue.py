...
def model_envalue(lables,predict):
    ...
    for i,real in enumerate(input_index):
        ...
        w6 = 0.1
        real = real
        f = open('D:\BoYun Company\Https_Project\module result\output\dtw\8.29result.txt', 'a')
        print('---------------------------------------------------START-----------------------------------------------',
              file=f)
    ...
    principle.to_csv(r'D:\BoYun Company\Https_Project\module result\output\dtw\8.29principle.csv',index=False)
