...
def model_envalue(lables,predict):
    ...
    for i,real in enumerate(input_index):
        ...
        w6 = 0.1
        real = real
        f = open('D:\BoYun Company\Https_Project\module result\output\8.30result_sax.txt', 'a')
        print('---------------------------------------------------START-----------------------------------------------',
              file=f)
    ...
    principle.to_csv(r'D:\BoYun Company\Https_Project\module result\output\8.30principle_sax.csv',index=False)